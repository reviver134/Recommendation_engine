...
class Network(BaseModel):
    GSM: Optional[Union[str, List[str]]] = None
    W_CDMA: Optional[Union[str, List[str]]] = None
    LTE: Optional[Union[str, List[str]]] = None
    five_G_NR: Optional[Union[str, List[str]]] = None

class Mobile_network_technologies_and_bandwidths(BaseModel):
    Mobile_network_technologies: Optional[Union[str, List[str]]] = None
...
class System_on_chip(BaseModel):
    ...
    RAM_capacity: Optional[Union[str, List[str]]] = None
    RAM_type: Optional[str] = None
    RAM_channels: Optional[str] = None
    RAM_frequency: Optional[str] = None

class Storage(BaseModel):
    Storage: Optional[Union[str, List[str]]] = None

class Display(BaseModel):
    Type_or_Technology: Optional[str] = None
    Diagonal_size: Optional[Union[str, List[str]]] = None
    Width: Optional[str] = None
    Height: Optional[str] = None
...
class Wi_Fi(BaseModel):
    Wi_Fi: Optional[Union[str, List[str]]] = None
...
class Connectivity(BaseModel):
    connectivity: Optional[Union[str, List[str]]] = None

class Browser(BaseModel):
    Browser: Optional[Union[str, List[str]]] = None

class Audio_file_formats(BaseModel):
    Audio_file_formats: Optional[Union[str, List[str]]] = None

class Video_file_formats(BaseModel):
    Video_file_formats: Optional[Union[str, List[str]]] = None
